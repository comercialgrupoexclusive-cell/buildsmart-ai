...
export function PortfolioResumo() {
                    ...
                    {obra.total_orcado > 0 && (
                      <div className="rounded-xl p-4" style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border)' }}>
                        ...
                        <div className="flex flex-col gap-2">
                          {[
                            { label: `Subtotal s/ BDI`, value: obra.subtotal, color: 'var(--accent)' },
                            { label: `BDI (${obra.bdi}%)`, value: obra.total_orcado - obra.subtotal, color: '#8B5CF6' },
