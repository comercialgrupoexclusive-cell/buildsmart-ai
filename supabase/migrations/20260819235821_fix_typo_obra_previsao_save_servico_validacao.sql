-- Corrige erro de digitacao introduzido na migration anterior: a validacao
-- de servico_id comparava etapas.id com subetapas_cronograma.obra_id (coluna
-- que nao existe), em vez de subetapas_cronograma.etapa_id. Sem essa
-- correcao, qualquer obra_previsao_save com servicoId preenchido falharia
-- com "column se.obra_id does not exist".
