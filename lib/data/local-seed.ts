...
export function createLocalSeed(): LocalDatabase {
  ...
  return {
    ...
    materiais: [
      ...
      { id: 'mat-tinta', obra_id: obraId, etapa_id: 'etapa-acabamento', subetapa: 'Paredes internas', sinapi_codigo: '00007356', descricao: 'Tinta latex acrilica premium', unidade: 'L', quantidade_total: 26.4, quantidade_comprada: 10, status_compra: 'parcial', data_necessidade: '2026-08-10', data_recebimento: null },
      { id: 'mat-porcelanato', obra_id: obraId2, etapa_id: 'etapa-acabamentos-2', subetapa: 'Loja - area de vendas', sinapi_codigo: 'IP-002', descricao: 'Porcelanato acetinado 60x60 cm', unidade: 'M2', quantidade_total: 47.25, quantidade_comprada: 0, status_compra: 'nao_comprado', data_necessidade: '2026-07-15', data_recebimento: null },
      { id: 'mat-argamassa', obra_id: obraId2, etapa_id: 'etapa-acabamentos-2', subetapa: 'Loja - area de vendas', sinapi_codigo: 'IP-003', descricao: 'Argamassa colante AC-III', unidade: 'KG', quantidade_total: 202.5, quantidade_comprada: 0, status_compra: 'nao_comprado', data_necessidade: '2026-07-15', data_recebimento: null },
